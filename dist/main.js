...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_handlers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/handlers.js */ \"./src/modules/handlers.js\");\n/* harmony import */ var _modules_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/utils.js */ \"./src/modules/utils.js\");\n\n\n\n\nconst handlers = new _modules_handlers_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\nconst form = document.querySelector('form');\nconst refresh = document.querySelector('.refresh');\n\nwindow.addEventListener('DOMContentLoaded', async () => {\n  await handlers.createNewGame();\n  handlers.refreshScores();\n  _modules_utils_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].toggleTheme();\n\n  form.addEventListener('submit', (e) => {\n    e.preventDefault();\n    handlers.postScore();\n    _modules_utils_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].clearInput();\n  });\n\n  refresh.addEventListener('click', () => handlers.refreshScores());\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ FetchHandlers)\n/* harmony export */ });\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ \"./src/modules/utils.js\");\n/* harmony import */ var _userScore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./userScore.js */ \"./src/modules/userScore.js\");\n/* eslint-disable class-methods-use-this */\n\n\n\nclass FetchHandlers {\n  async get(endpoint) {\n    const response = await fetch(endpoint);\n    const data = await response.json();\n    return data;\n  }\n\n  async post(endpoint, data) {\n    try {\n      const response = await fetch(endpoint, {\n        method: 'POST',\n        headers: {\n          'Content-Type': 'application/json',\n        },\n        body: JSON.stringify(data),\n      });\n      return response.json();\n    } catch (e) {\n      throw new Error(e);\n    }\n  }\n\n  async createNewGame() {\n    if (_utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getFromStorage()) {\n      return;\n    }\n    const { result } = await this.post('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', { name: 'My cool new game' });\n    const id = result.slice(15, -7);\n    _utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].addToStorage(id);\n  }\n\n  async postScore() {\n    const user = document.querySelector('.user_name').value.trim();\n    const score = document.querySelector('.user_score').value.trim();\n    const item = new _userScore_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](user, score);\n    try {\n      const { result } = await this.post(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${_utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getFromStorage()}/scores`, item);\n\n      _utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].displayStatus(result);\n    } catch (e) {\n      throw new Error(e);\n    }\n  }\n\n  async refreshScores() {\n    try {\n      const { result } = await this.get(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${_utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getFromStorage()}/scores`);\n\n      _utils_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].displayScores(result);\n    } catch (e) {\n      throw new Error(e);\n    }\n  }\n}\n\n//# sourceURL=webpack://leaderboard/./src/modules/handlers.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ UserScore)\n/* harmony export */ });\nclass UserScore {\n  constructor(user, score) {\n    this.user = user;\n    this.score = score;\n  }\n}\n\n//# sourceURL=webpack://leaderboard/./src/modules/userScore.js?");
